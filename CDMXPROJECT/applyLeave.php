                   ...
                   <form action="" method="post" class="well form-horizontal">
                      <fieldset>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span><input id="todate" name="todate" placeholder="To Date" class="form-control" required="true" value="" type="date"></div>
                            </div>
                         </div>
