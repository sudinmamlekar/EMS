...
<script>
function checkdesgAvailability() {
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availability.php",
data:'desgid='+$("#desgid").val(),
type: "POST",
success:function(data){
//var result = $.trim(data);
 // console.log(data);
$("#desg-availability-status").html(data);
      ...
      <div class="modal-content">
        ...
        <form action="" method="post" id="form-data">
          <div class="form-group">
            <input type="text" name="dname" class="form-control" placeholder="Designation Name" id="desgid" onBlur="checkdesgAvailability()" required> 
            <span id="desg-availability-status"></span>
          </div>
    
            <div class="form-group">
            <input name="insert" id="insert" type="submit" value="Add Designation" class="btn btn-danger btn-block">
            </div>
